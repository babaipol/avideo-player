          ...
          {impactStats.map((stat, index) => {
            ...
            return (
              <motion.div
                ...
                className="group relative p-6 rounded-2xl bg-white/5 border border-white/10 hover:border-cyan-500/30 hover:bg-white/8 transition-all duration-300 overflow-hidden"
              >
